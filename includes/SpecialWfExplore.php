...
class SpecialWfExplore extends SpecialPage {
	...
	public function execute( $par ) {
		...
		$out->getOutput ()->addModules( array('ext.wikifab.wfexplore.dynatree.js', 'ext.wikifab.wfExplore.js') );
		...
		$this->WfExploreCore->extractTags($request, $this->params);
	...
	public function showResults( ) {
		...
		$out->addHtml(  $this->WfExploreCore->getSearchResultsHtml($this->params));
